      ...
      <section className="relative border-b border-white/5 overflow-hidden bg-[#030304]">
        ...
        <div className="container relative py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-white mb-4 leading-none">
              Bounty{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-purple to-neon-cyan">
                Board
              </span>
            </h1>
            <p className="text-muted-foreground text-base max-w-xl leading-relaxed font-mono">
            ...
            <div className="flex items-center gap-4 mt-8">
              {user && (
                <PostBountyDialog>
                  <button
                    id="post-bounty-btn"
                    className="flex items-center gap-2 bg-neon-purple hover:bg-neon-purple/90 text-white px-6 py-3 font-black uppercase tracking-widest text-xs shadow-[0_0_20px_rgba(168,85,247,0.3)] transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.5)]"
                  >
              ...
              {isModder && (
                <span className="flex items-center gap-2 text-xs text-neon-green font-mono border border-neon-green/20 px-4 py-3 bg-neon-green/5">
                  <Zap className="h-3 w-3" />
                  Você pode se candidatar às encomendas abertas
                </span>
              )}
            </div>
          </div>
