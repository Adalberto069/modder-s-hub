--[[
    NEXUS SOCIETY - ELITE LOADER PROTOTYPE
    Developed for Nexus Society Ecosystem
]]

local API_URL = "https://rdagqukqmphvlxbrefil.supabase.co/functions/v1"
local SAVE_PATH = gg.EXT_STORAGE .. "/nexus_license.txt"
...
local function splash()
    ...
    ]] .. WHITE .. [[S O C I E T Y  |  E L I T E  M O D S
    --------------------------------------
...
local function main()
    ...
    if not key then
        local prompt = gg.prompt({"Digite sua Licença Nexus:"}, {""}, {"text"})
    ...
    local menu = gg.choice(titles, nil, "NEXUS SOCIETY - SELECIONE O SCRIPT")
